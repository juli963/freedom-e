#!/bin/bash
    ...
    if [ $1 = "c" ]; then
        ...
        g++ -Iobj_dir -Iusr -I/usr/share/verilator/include obj_dir/VRMII__Syms.cpp obj_dir/VRMII__Trace__Slow.cpp obj_dir/VRMII__Trace.cpp obj_dir/VRMII.cpp usr/PHY_Bus2.cpp usr/RMII_PHY.cpp usr/testbench.cpp usr/RMII.cpp /usr/share/verilator/include/verilated.cpp /usr/share/verilator/include/verilated_vcd_c.cpp -o usr/testbench.o
