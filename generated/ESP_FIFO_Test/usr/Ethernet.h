    ...
    class Ethernet {
        ...
        public:
            Ethernet(ESP_FIFO_Test_TB *tb) { // Constructor with parameters
                this->tb = tb;
            }
            ESP_FIFO_Test_TB *tb;
            void init();
            ...
            void createESPFrame(uint8_t* destIP, uint8_t* destMAC, uint8_t type, uint8_t ident, uint8_t cmd, uint8_t address, uint32_t data);
