...
void bus_to_phy( GMII_TB* tb, PHY *phy, PHY_Bus2 *bus, bool* berror );
void phy_to_bus( GMII_TB* tb, PHY *phy, PHY_Bus2 *bus, bool* berror, bool with_Col );
...
int main(int argc, char **argv) {
        ...
        GMII_PHY::rx_signals Gphy_signals_rx = {
                .RXCLK = &tb->m_core->io_intf_rx_RXCLK,
                .RXDV = &tb->m_core->io_intf_rx_RXDV, 
                .RXER = &tb->m_core->io_intf_rx_RXER, 
                .RXD = &tb->m_core->io_intf_rx_RXD,
        ...
        GMII_PHY::tx_signals Gphy_signals_tx = {
                .GTXCLOCK = &tb->m_core->io_intf_tx_GTXCLOCK,
                .TXEN = &tb->m_core->io_intf_tx_TXEN, 
                .TXER = &tb->m_core->io_intf_tx_TXER, 
                .TXD = &tb->m_core->io_intf_tx_TXD
        };
        ...
        GMII_PHY *Gphy = new GMII_PHY(Gphy_signals_tx, Gphy_signals_rx);
...
//bool MII_PHY::get_tx_data(uint8_t* data, bool* error, bool* nibbleend)
        ...
        // GMII Part
                ...
                //printf("Phy to Bus \n");
                phy_to_bus( tb, Gphy, bus, &error_n, true );
