...
bool RGMII_PHY::get_tx_data(uint8_t* data, bool* error, bool* nibbleend){     // return 1 when data is available
    bool ret = false;
...
bool RGMII_PHY::send_rx_data(uint8_t* data, bool* error, bool* col, uint16_t len){    // return is busy state
