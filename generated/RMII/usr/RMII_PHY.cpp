...
bool RMII_PHY::get_tx_data(uint8_t* data, bool* error, bool* nibbleend){     // return 1 when data is available
    bool ret = false;
...
bool RMII_PHY::send_rx_data(uint8_t* data, bool* error, bool* col, bool crs, uint16_t len){    // return is busy state
