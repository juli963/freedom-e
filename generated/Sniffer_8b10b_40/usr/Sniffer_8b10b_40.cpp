...
void Sniffer_8b10b_40_TB::deq_hw_fifo(uint8_t en, uint8_t num){
    switch(num){
        case 0:
            m_core->io_data_deq_0_ready = en;
            m_core->io_mgmt_deq_0_ready = en;
            break;
        case 1:
            m_core->io_data_deq_1_ready = en;
            m_core->io_mgmt_deq_1_ready = en;
            break;
        break;   
    }
}